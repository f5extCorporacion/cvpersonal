              ...
              <div class="card-body p-4 print:p-3">
                ...
                <div class="grid grid-cols-1 gap-2 print:gap-1">
                  <div 
                    ...
                    @click="estudio.certificado ? openCertificate(estudio.certificado) : null"
                  >
                    <div class="card-body p-3 print:p-2">
                      <div class="flex items-start gap-2">
                        ...
                        <ArrowTopRightOnSquareIcon v-if="estudio.certificado" class="w-4 h-4 text-primary flex-shrink-0 print:hidden" />
                        <div v-else class="w-4 h-4 text-base-content/30 flex-shrink-0 print:hidden">✕</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 print:gap-2">
                  <div v-for="creacion in perfil.creaciones" :key="creacion.title" class="card bg-base-100 shadow-sm hover:shadow-md transition-shadow print:shadow-none print:bg-white">
                    <div class="card-body p-3 print:p-2">
                      ...
                      <a :href="creacion.link" target="_blank" class="link link-primary text-xs flex items-center gap-1 mt-1 hover:gap-2 transition-all print:text-[10px] print:no-underline">
